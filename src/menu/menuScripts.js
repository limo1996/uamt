                ...
                if(rawFile.status === 200 || rawFile.status == 0)
                {
                    ...
                    var content = "<div class='navbar-header'>" +
                                        "<button type='button' class='navbar-toggle' data-toggle='collapse' data-target='.navbar-collapse'>" +
                                            ...
                                            "<span class='icon-bar'></span>" +
                                        "</button>" +
                                    "<p class='navbar-brand' style='color:#0066cc;'>UAMT</p>" +
                                "</div>"+
                                "<div class='container'>" +
                    ...
                    content +=  "<div class='navbar-flag2'>";
                    content += "<a href='#'>";
                    content += "<span class='span-logo'>";
                    content += "<img src='http://147.175.98.167/uamt/menu/images/gb.gif' class='sk-logo' />";
                    content += "</span>"
                    content += "</a>"
                    content += "</div>"
                    content += "</ul>"

                    content +=  "<div class='navbar-flag1'>";
                    content += "<a href='#'>";
                    content += "<span class='span-logo'>";
                    content += "<img src='http://147.175.98.167/uamt/menu/images/sk.gif' class='sk-logo' />";
                    content += "</span>"
                    content += "</a>"
                    content += "</div>"
                    content += "</ul>"
