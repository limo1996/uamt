...
<html>
<head lang="sk">
    <title><?php echo $text->study_bc_thesis;?></title>
    <meta charset="utf-8">
...
<div id="content">
    ...
    <div class="col-sm-6">
        ...
        <article>
        <p><b>Ukončovanie predmetov BP1, BP2, BZP</b></p>
            ...
            <ul>
                ...
                <li>Pre získanie klasifikovaného zápočtu musí študent odovzdať technickú dokumentáciu svojmu vedúcemu práce v nim špecifikovanom rozsahu najneskôr do 20.januára daného roku. Prácu na projekte hodnotí vedúci práce.</li>

            </ul>
            <p>Bakalársky projekt 2</p>
            <ul>
                <li>Zodpovedný: 			doc. Ing. Vladimír Kutiš, PhD.</li>
                <li>Hodnotenie predmetu: 		klasifikovaný zápočet</li>
