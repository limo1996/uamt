...
<html>
<head lang="sk">
    <title><?php echo $text->study_ing_info;?></title>
    <meta charset="utf-8">
...
<div id="nazov">
    <h2><?php echo $text->study_ing . " - ". $text->study_ing_info;?></h2>
    <hr class="hr_nazov">
</div>
...
<div id="content">
    ...
    <div class="col-sm-6">
        ...
        <article>
            ...
            <p>Záver inžinierskeho  štúdia</p>
            <ul>
            ...
            <p><b>Študijný plán 2016-2017</b>  (<a href="/uamt/study/SP20172018i.pdf">SP20172018i.pdf</a>)</p>
